        ...
        <div className="mx-auto max-w-2xl">
          ...
          <article>
            <header className="flex flex-col">
              ...
              <HeroHeading
                text={"Crafting a design system for a multiplanetary future"}
              />
            </header>
            ...
            >
              ...
              <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                ...
                viewing conditions of someone from the future, so I grabbed my
                space helmet from the closet, created a new Figma document, and
                got to work.
              </p>
              <h2 className="text-highlight mt-6 sm:text-2xl">Sermone fata</h2>
              <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                Lorem markdownum, bracchia in redibam! Terque unda puppi nec,
                linguae posterior in utraque respicere candidus Mimasque formae;
                quae conantem cervice. Parcite variatus, redolentia adeunt.
                Tyrioque dies, naufraga sua adit partibus celanda torquere
                temptata, erit maneat et ramos,{" "}
                <a href="#" className="text-highlight">
                  iam
                </a>{" "}
                ait dominari potitus! Tibi litora matremque fumantia condi
                radicibus opusque.
              </p>
              <p className="mt-6 mb-6 text-base text-zinc-600 dark:text-zinc-400">
                ...
                simulatoremque sanguine, at voce aestibus diu! Quid veterum
              ...
              <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                ...
                Herses omnes nec divite: et ille illa furit sim verbis
                Cyllenius.
              </p>
              <ol>
                {[
              ...
              <p className="mt-6 mb-6 text-base text-zinc-600 dark:text-zinc-400">
                ...
                expugnacior est pennas iniqui ecce <strong>haeret</strong>{" "}
                genus: peiora imagine fossas Cephisos formosa! Refugitque amata{" "}
                <a href="#" className="text-highlight">
                  refelli
                </a>
                supplex. Summa brevis vetuere tenebas, hostes vetantis,
                suppressit, arreptum regna. Postquam conpescit iuvenis habet
              ...
              />
              <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                Sit volat naturam; motu Cancri. Erat pro simul quae valuit
                quoque timorem quam proelia: illo patrio <em>esse summus</em>,
                enim sua serpentibus, Hyleusque. Est coniuge recuso; refert
                Coroniden ignotos manat, adfectu.
              </p>
            </div>
          </article>
        </div>
